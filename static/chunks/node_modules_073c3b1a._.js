...
"[project]/node_modules/use-local-storage-state/src/useLocalStorageState.js [app-client] (ecmascript)": ((__turbopack_context__) => {
"use strict";

var { g: global, __dirname } = __turbopack_context__;
{
__turbopack_context__.s({
    "default": (()=>useLocalStorageState),
...
function useLocalStorageState(key, options) {
    ...
    const [defaultValue] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])(options?.defaultValue);
    const [defaultServerValue] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])(options?.defaultServerValue);
...
function useLocalStorage(key, defaultValue, defaultServerValue, storageSync = true, parse = parseJSON, stringify = JSON.stringify) {
    ...
    const storageItem = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useRef"])({
        string: null,
        parsed: undefined
    });
    const value = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useSyncExternalStore"])(// useSyncExternalStore.subscribe
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "useLocalStorage.useSyncExternalStore[value]": (onStoreChange)=>{
            const onChange = {
                "useLocalStorage.useSyncExternalStore[value].onChange": (localKey)=>{
                    if (key === localKey) {
                        onStoreChange();
                    }
                }
            }["useLocalStorage.useSyncExternalStore[value].onChange"];
            callbacks.add(onChange);
            return ({
                "useLocalStorage.useSyncExternalStore[value]": ()=>{
        ...
        "useLocalStorage.useSyncExternalStore[value]": // useSyncExternalStore.getSnapshot
        ()=>{
            const string = goodTry({
                "useLocalStorage.useSyncExternalStore[value]": ()=>localStorage.getItem(key)
            }["useLocalStorage.useSyncExternalStore[value]"]) ?? null;
        ...
        "useLocalStorage.useSyncExternalStore[value]": // useSyncExternalStore.getServerSnapshot
    ...
    const setState = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "useLocalStorage.useCallback[setState]": (newValue)=>{
    ...
    const removeItem = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "useLocalStorage.useCallback[removeItem]": ()=>{
            goodTry({
                "useLocalStorage.useCallback[removeItem]": ()=>localStorage.removeItem(key)
            }["useLocalStorage.useCallback[removeItem]"]);
            inMemoryData.delete(key);
            triggerCallbacks(key);
        }
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "useLocalStorage.useEffect": ()=>{
            ...
            const onStorage = {
                "useLocalStorage.useEffect.onStorage": (e)=>{
                    if (e.key === key && e.storageArea === goodTry({
                        "useLocalStorage.useEffect.onStorage": ()=>localStorage
                    }["useLocalStorage.useEffect.onStorage"])) {
                        triggerCallbacks(key);
                    }
                }
            }["useLocalStorage.useEffect.onStorage"];
            ...
            return ({
                "useLocalStorage.useEffect": ()=>window.removeEventListener('storage', onStorage)
            })["useLocalStorage.useEffect"];
        }
    }["useLocalStorage.useEffect"], [
        key,
...
"[project]/node_modules/use-local-storage-state/index.js [app-client] (ecmascript)": ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$use$2d$local$2d$storage$2d$state$2f$src$2f$useLocalStorageState$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/use-local-storage-state/src/useLocalStorageState.js [app-client] (ecmascript)");
;
const __TURBOPACK__default__export__ = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$use$2d$local$2d$storage$2d$state$2f$src$2f$useLocalStorageState$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"];
}}),
}]);

//# sourceMappingURL=node_modules_073c3b1a._.js.map