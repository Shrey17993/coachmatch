...
function getCoachingRecommendations(answers) {
    ...
    const personalityType = __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$data$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["personalityTypes"].find((p)=>p.trait === dominantTrait) || __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$data$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["personalityTypes"].find((p)=>p.trait === 'balanced-pace');
    const studentTraits = sortedTraits.slice(0, 3).map((t)=>t.trait);
    // 3. Match with coaching profiles
    const scoredCoachings = __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$data$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["coachingProfiles"].map((coaching)=>{
...
function QuizPage() {
    ...
    const [recommendationsResult, setRecommendationsResult] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$use$2d$local$2d$storage$2d$state$2f$index$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["default"])('recommendationsResult', {
        defaultValue: null
    });
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useEffect"])(()=>{
        ...
        if (recommendationsResult && Object.keys(answers).length === __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$data$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["quizQuestions"].length) {
            setQuizState("results");
        } else {
            const answeredCount = Object.keys(answers).length;
            if (answeredCount > 0 && answeredCount < __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$data$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["quizQuestions"].length) {
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useEffect"])(()=>{
        const answeredCount = Object.keys(answers).length;
        if (answeredCount === __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$data$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["quizQuestions"].length && quizState === "in_progress" && !recommendationsResult) {
        ...
        try {
            await streamRationale(studentTraits, rec.tags, (chunk)=>{
                if (chunk.goodFitRationale || chunk.badFitRationale) {
                    setRecommendationsResult((prevState)=>{
...
//# sourceMappingURL=%5Broot-of-the-server%5D__8c832c20._.js.map